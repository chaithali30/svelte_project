		...
		<div class="hidden w-full md:block md:w-auto" id="navbar-default">
			<ul
				...
				<li>
					<a
						href="/"
						class="block py-2 pr-4 pl-3 rounded md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 text-black hover:bg-gray-700 hover:text-blue-400 hover:bg-transparent"
						>Home</a>
				</li>
				<li>
					<a
